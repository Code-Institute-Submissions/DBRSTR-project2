  ...
  function confirmCard() {
      ...
      noticeArea = document.getElementById('opponent-choice');
  ...
  function scoreTally() {
      ...
      if (score == 5) {
          let declareGameWinner = 'win';
          calculateGameWinner(declareGameWinner);
  ...
  function loseLife() {
      ...
      if (lives == 0) {
          let declareGameWinner = 'lose';
          calculateGameWinner(declareGameWinner);
      };
  };


  function calculateGameWinner(declareGameWinner) {

      let gameNoticeArea = document.getElementById('game-wrapper');

      let declareWinner = `
        <h3 style="text-transfom: uppercase">congratulations!</h3>
        <p>You won the game</p>
        <a href="index.html">Play Again?</a>
        `;
      let declareLoser = `
        <h3 style="text-transfom: uppercase">better luck next time</h3>
        <p>The computer got lucky</p>
        <a href="index.html">Play Again?</a>
        `;

      if (declareGameWinner === 'win') {
          gameNoticeArea.innerHTML = declareWinner;
      } else if (declareGameWinner === 'lose') {
          gameNoticeArea.innerHTML = declareLoser;
      }
